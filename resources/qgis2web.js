...
map.getView().fit([673108.848926, 5801180.470964, 693843.302917, 5822524.876825], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_OTC_STATIONNEMENT_V_PUBLIQUE_1,
    colName: 'type_stationnement',
    zoom: 10,
    collapsed: true,
    map: map
});
